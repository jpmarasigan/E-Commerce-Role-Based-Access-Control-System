# E-Commerce Role-Based Access Control (RBAC) System
...
- **Admin Features**:
  ...
  - **Dashboard**: Visual representation of data, such as total orders, product sales, and active users, using **Chart.js**.
